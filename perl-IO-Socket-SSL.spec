...
Source0  : https://cpan.metacpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.083.tar.gz
...
%prep
%setup -q -n IO-Socket-SSL-2.083
cd %{_builddir}/IO-Socket-SSL-2.083
pushd ..
cp -a IO-Socket-SSL-2.083 buildavx2
popd
