...
Source0  : https://cpan.metacpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.088.tar.gz
...
%prep
%setup -q -n IO-Socket-SSL-2.088
cd %{_builddir}/IO-Socket-SSL-2.088
pushd ..
cp -a IO-Socket-SSL-2.088 buildavx2
popd
