...
Source0  : https://cpan.metacpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.085.tar.gz
...
%prep
%setup -q -n IO-Socket-SSL-2.085
cd %{_builddir}/IO-Socket-SSL-2.085
pushd ..
cp -a IO-Socket-SSL-2.085 buildavx2
popd
