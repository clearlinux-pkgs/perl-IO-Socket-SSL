...
Source0  : https://cpan.metacpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.084.tar.gz
...
%prep
%setup -q -n IO-Socket-SSL-2.084
cd %{_builddir}/IO-Socket-SSL-2.084
pushd ..
cp -a IO-Socket-SSL-2.084 buildavx2
popd
